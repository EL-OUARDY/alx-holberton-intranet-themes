...
function applyTheme(state) {
    ...
    const cssFile = state.activeTheme.mode == "dark"
...
function createFocusModeControls() {
    ...
    const projectTitleElement = document.querySelector("html.intanet-themes .project>div>h1");
